...
[![Update Hashes](https://img.shields.io/github/actions/workflow/status/JigenxOhtsusuki/spotify-gql-registry/update-hashes.yml?label=scraper&style=flat-square)](../../actions/workflows/update-hashes.yml)
